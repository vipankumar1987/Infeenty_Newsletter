 ...
 */
class Infeenty_Newsletter_Model_Mysql4_Newsletterfield_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
	public function _construct(){
		//parent::_construct();
		$this->_init('infeentynewsletter/newsletterfield');
	}
}
