...
class Infeenty_Newsletter_Block_Adminhtml_Newsletter_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('newsletter_form', array('legend'=>Mage::helper('newsletter')->__('Form information')));
